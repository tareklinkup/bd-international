            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>PO No. :</strong> {{ sales.po_no }}<br>
                        <strong>BIN No. :</strong> {{ sales.bin_no }}<br>
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right">{{ sales.SaleMaster_AIT }}</td>
                            </tr>
                            <tr>
                ...
                printWindow.document.write(`
                    ...
                    <body>
                        <div class="row" style="padding:0px;margin:0px;">
                            <img src="${this.currentBranch.header_logo}" alt="Logo" style="width:100%; height:100px;" />
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
				...
				printWindow.document.write(`
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="row" style=";margin-bottom:5px;padding-bottom:6px;position:fixed;left:10px;bottom:50px;right:10px">
                                <div class="col-xs-4">
                                ...
                                ${this.currentBranch.brunch_id == 1 ? '<img src="/uploads/signature.png" width="80" style="position:absolute;top:-90px;right:13px;">':''}                                        
                            ...
                            <div style="position:fixed;left:0;bottom:15px;width:100%;">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div style="padding:10px 10px;background-color:#385785 !important;">
                                            <div style="color:white !important;font-size:17px;text-align:center; font-weight:bolder">
