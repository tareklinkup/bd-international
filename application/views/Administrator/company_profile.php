				...
				<div class="row" style="margin-top: 15px;">
					<div class="col-md-12">
						<form class="form-horizontal" @submit.prevent="saveBranch">
							...
							<!-- header and footer -->
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"> Header Image <br> (600 X 100) px</label>
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-8">
									<input type="file" id="headerImage" name="headerImage" :ref="'image'" @change="previewImage" class="form-control" style="height: 35px;">
								</div>
							</div>
								...
								<div class="col-sm-12">
									<div style="float:right">
										<div style="width: 100px; height:100px;border: 1px solid #ccc;overflow:hidden;">
											<img id="customerImage" v-if="imageUrlHeader == '' || imageUrlHeader == null" src="/assets/no_image.gif" style="width: 100px;height:100px">
											<img id="customerImage" v-if="imageUrlHeader != '' && imageUrlHeader != null" v-bind:src="imageUrlHeader" style="width: 100px;height:100px">
										</div>
									</div>
								</div>						
							</div>
