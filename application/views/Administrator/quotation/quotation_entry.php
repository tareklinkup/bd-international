...
<div id="quotation" class="row">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            ...
            <div class="form-group">
                <label class="col-xs-1 control-label no-padding-right"> Quote. By </label>
                <div class="col-xs-2">
            ...
            <div class="form-group">
                <label class="col-xs-1 control-label no-padding-right"> Quote. From </label>
                <div class="col-xs-2">
            ...
            <!-- <div class="form-group">
                <div class="col-xs-3">
                    <input class="form-control" type="date" id="quotationDate" v-model="quotation.quotationDate" />
                </div>
            </div> -->

            <div class="form-group">
                <div class="col-sm-3">
                    <input class="form-control" id="salesDate" type="date" v-model="quotation.quotationDate" />
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-5">
                            <div class="form-group clearfix">
                                ...
                                <div class="col-xs-8">
                                    <v-select v-bind:options="customers" v-model="selectedCustomer" id="customer"
                                        label="display_name" @input="changeCustomer"></v-select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input type="text" placeholder="Mobile No"
                                        :disabled="quotation.customerMobile?true:false" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <textarea placeholder="Address" class="form-control"
                                        :disabled="quotation.customerMobile?true:false"
    ...
    methods: {
        ...
        changeCustomer() {
            if (this.selectedCustomer.Customer_SlNo == undefined) {
                this.quotation = {
                    ...
                    customerMobile: "General Customer",
                    customerAddress: "General Customer",
                    quotationBy: '<?php echo $this->session->userdata("FullName"); ?>',
                    quotationFrom: '',
                    quotationDate: "",
                    subTotal: 0.00,
        ...
        getQuotations() {
            axios.post('/get_quotations', {
                ...
                this.quotation.quotationDate = quotation.SaleMaster_SaleDate;
