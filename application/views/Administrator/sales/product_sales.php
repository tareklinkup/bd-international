	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" id="invoiceNo" class="form-control" v-model="sales.chalan_no" placeholder="Chalan No"/>
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right"> BIN No </label>
				<div class="col-sm-2">
				<input type="text" id="invoiceNo" class="form-control" v-model="sales.bin_no" placeholder="BIN No"/>
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right"> PR/PO No</label>
				<div class="col-sm-2">
					<input type="text" id="invoiceNo" class="form-control" v-model="sales.po_no" placeholder="PR/PO No"/>
				</div>
			</div>
		</div>
							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">AIT Percent</label>

												<div class="col-xs-4">
													<input type="number" step="0.01" id="aitPercent" class="form-control" v-model="aitPercent" v-on:input="calculateTotal"/>
												</div>

												<label class="col-xs-1 control-label no-padding-right">%</label>

												<div class="col-xs-7">
													<input type="number" step="0.01" id="aitamount" class="form-control" v-model="sales.aitamount" v-on:input="calculateTotal"/>
												</div>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-4">
													<input type="number" step="0.01" id="vatPercent" class="form-control" v-model="vatPercent" v-on:input="calculateTotal"/>
												</div>

												<label class="col-xs-1 control-label no-padding-right">%</label>

												<div class="col-xs-7">
													<input type="number" step="0.01" id="vat" class="form-control" v-model="sales.vat" v-on:input="calculateTotal"/>
												</div>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">Discount Percent</label>

												<div class="col-xs-4">
													<input type="number" step="0.01" id="discountPercent" class="form-control" v-model="discountPercent" v-on:input="calculateTotal"/>
												</div>

												<label class="col-xs-1 control-label no-padding-right">%</label>

												<div class="col-xs-7">
													<input type="number" step="0.01" id="discount" class="form-control" v-model="sales.discount" v-on:input="calculateTotal"/>
												</div>
	...
	new Vue({
		...
		methods:{
			...
			calculateTotal(){
				...
				if(event.target.id == 'aitPercent'){
					this.sales.aitamount = ((parseFloat(this.sales.subTotal) * parseFloat(this.aitPercent)) / 100).toFixed(2);
				} else {
					this.aitPercent = (parseFloat(this.sales.aitamount) / parseFloat(this.sales.subTotal) * 100).toFixed(2);
				}

				this.tempTotalF = (parseFloat(this.sales.subTotal) + parseFloat(this.sales.aitamount));
				console.log(this.tempTotalF);
				if(event.target.id == 'vatPercent'){
					this.sales.vat = ((parseFloat(this.tempTotalF) * parseFloat(this.vatPercent)) / 100).toFixed(2);
				} else {
					this.vatPercent = (parseFloat(this.sales.vat) / parseFloat(this.tempTotalF) * 100).toFixed(2);
				}

				this.tempTotalS = parseFloat(this.tempTotalF) + parseFloat(this.sales.vat);
				if(event.target.id == 'discountPercent'){
					this.sales.discount = ((parseFloat(this.tempTotalS) * parseFloat(this.discountPercent)) / 100).toFixed(2);
				} else {
					this.discountPercent = (parseFloat(this.sales.discount) / parseFloat(this.tempTotalS) * 100).toFixed(2);
				}
				this.sales.total = ((parseFloat(this.sales.subTotal) + parseFloat(this.sales.vat) + parseFloat(this.sales.transportCost) + parseFloat(this.sales.aitamount)) - parseFloat(this.sales.discount)).toFixed(2);
			...
			async saveSales(){
				...
				if(this.sales.chalan_no.length > 50){
					alert('Chalan No Maximum 50 Character');
					return;
				}
				if(this.sales.bin_no.length > 50){
					alert('BIN No Maximum 50 Character');
					return;
				}
				if(this.sales.po_no.length > 50){
					alert('PO No Maximum 50 Character');
					return;
				}
			...
			async getSales(){
				await axios.post('/get_sales', {salesId: this.sales.salesId}).then(res=>{
					...
					this.sales.aitamount = sales.SaleMaster_AIT;
